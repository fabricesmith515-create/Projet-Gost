      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-white/80 text-base sm:text-lg">
            De la fiction grand public aux ouvrages d'autorité professionnelle, notre collectif couvre tous les genres littéraires.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 text-xs font-semibold text-white group-hover:text-[#F6A028] transition-colors pt-4 border-t border-white/10"
                >
        ...
        <div className="text-center mt-12">
          <Link
            href="/services"
            className="btn-white-pill text-xs px-8 py-3.5 inline-flex items-center gap-2"
          >
            <span>Voir le catalogue de prestations détaillé</span>
