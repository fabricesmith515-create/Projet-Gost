...
import { BookOpen, FileText, UserCheck, Mic, FileSpreadsheet, Edit3, Sparkles, BookHeart, Compass, Feather, Share2, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-white/80 text-base sm:text-lg">
            De la fiction grand public aux ouvrages d'autorité professionnelle. Obtenez votre devis personnalisé en Euros (€).
          </p>
        </div>
          ...
          {services.map((service) => {
            ...
            return (
              ...
              >
                ...
                <Link
                  href="/contact"
                  className="btn-white-pill text-xs px-4 py-2.5 inline-flex items-center justify-between w-full font-bold text-[#2A1B12] mt-4"
                >
        ...
        {/* Central Action Button #2 in Services Section */}
        <div className="text-center mt-12">
          <Link
            href="/contact"
            className="btn-white-pill text-sm px-8 py-4 inline-flex items-center gap-2 font-bold text-[#2A1B12] shadow-pill hover:scale-105"
          >
            <span>Contactez-nous</span>
